...
class MyPositionSeekWidget extends StatefulWidget {
  const MyPositionSeekWidget({
    Key key,
  ...
  @override
  _MyPositionSeekWidgetState createState() => _MyPositionSeekWidgetState();
}

class _MyPositionSeekWidgetState extends State<MyPositionSeekWidget> {
  ...
  @override
  void didUpdateWidget(covariant MyPositionSeekWidget oldWidget) {
